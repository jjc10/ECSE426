...
void acc_init(){
	...
	mems_init_struct.Power_Mode_Output_DataRate = LSM9DS1_DATARATE_238_XL;
	mems_init_struct.Axes_Enable = LSM9DS1_X_ENABLE_XL | LSM9DS1_Y_ENABLE_XL | LSM9DS1_Z_ENABLE_XL;
	mems_init_struct.Decimation = LSM9DS1_DECIMATION_0;
	mems_init_struct.BW_select = LSM9DS1_BW_SELECT_ODR;			
	mems_init_struct.Full_Scale = LSM9DS1_FULLSCALE_2_XL;
	mems_init_struct.AA_Filter_BW = LSM9DS1_AA_BW_XL_408;
	LSM9DS1_Acc_Init(&mems_init_struct);

	/*Configure MEMS interrupts */
	LSM9DS1_DRYInterruptConfigTypeDef mems_int_config_s;
	mems_int_config_s.XL_Dataready_Interrupt = LSM9DS1_INT1_DRDY_XL_ENABLE; 
	mems_int_config_s.G_Dataready_Interrupt = 0x00;//LSM9DS1_INT1_DRDY_G_ENABLE;
	LSM9DS1_INT_Config(&mems_int_config_s);
...
void gyro_init(){
	...
	mems_init_struct1.Axes_Enable = LSM9DS1_X_ENABLE_G | LSM9DS1_Y_ENABLE_G | LSM9DS1_Z_ENABLE_G;
	...
	NVIC_config_s.NVIC_IRQChannelPreemptionPriority = 0x01; //Set x higher than y
	NVIC_config_s.NVIC_IRQChannelSubPriority = 0x00;				//Set x1 higher the x2
	NVIC_config_s.NVIC_IRQChannelCmd = ENABLE;							//Enable
	NVIC_Init(&NVIC_config_s);
