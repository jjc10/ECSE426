...
/**
  ...
  */
//CONVERTED
void LSM9DS1_Acc_Init(LSM9DS1_InitTypeDef *LSM9DS1_InitStruct)
{
  uint8_t ctrl = 0x00;
...
/**
  ...
  */
//CONVERTED
void LSM9DS1_INT_Config(LSM9DS1_DRYInterruptConfigTypeDef *LSM9DS1_IntConfigStruct)
{
  uint8_t ctrl = 0x00;
  if(LSM9DS1_IntConfigStruct->XL_Dataready_Interrupt != 0x00){
  ...
  if(LSM9DS1_IntConfigStruct->G_Dataready_Interrupt != 0x00){
	  /* Read LSM9DS1_INT2_CTRL register */
	  LSM9DS1_Read(&ctrl, LSM9DS1_INT2_CTRL, 1);
	  
	  /* Configure latch Interrupt request, click interrupts and double click interrupts */                   
	  ctrl = (uint8_t)(LSM9DS1_IntConfigStruct->G_Dataready_Interrupt);
	  
	  /* Write value to LSM9DS1_INT2_CTRL register */
	  LSM9DS1_Write(&ctrl, LSM9DS1_INT2_CTRL, 1);
  }
