...
/**
  ...
  * @{
  */
#define LSM9DS1_AA_BW_XL_405				((uint8_t)0x00)
#define LSM9DS1_AA_BW_XL_201				((uint8_t)0x01)
...
void LSM9DS1_INT1_Config(LSM9DS1_DRYInterruptConfigTypeDef *LSM9DS1_InterruptConfigStruct);
